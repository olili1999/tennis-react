    ...
    <div>
      <div className={styles.outer_layer}>
        <span className={styles.table_header}>
          ...
          <div className={styles.mid_container}></div>
          <div className={styles.right_header_container}>1/5/2021</div>
        </span>
        <span className={styles.player_span}>
          ...
          <div className={styles.mid_container}>Rank #1</div>
        ...
        <span className={styles.player_span}>
          ...
          <div className={styles.mid_container}>Rank #10</div>
          <div className={styles.right_container}>
            <div className={`${styles.bold} ${styles.score_item}`}> 6 </div>
            <div className={styles.score_item}> 4</div>
