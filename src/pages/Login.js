        ...
        <div className = {styles.card}> 
          ...
          <form onSubmit = {handleSubmit} className = {styles.form}>
            ...
            <div className = {styles.login_button_div}> 
              <input disabled = {loading} className = {styles.login_button} type="submit" value = "Log In" id="login" name="login"/> <br/>
            </div>
            <div className = {styles.forgot_password_div}> 
              <Link to  = "/forgotpassword" style = {{color: '#206a5d', fontWeight: 'bold'}}> Forgot password? </Link>  
            </div>
          </form>
